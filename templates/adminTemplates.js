const jobAnnouncementTeam = (team_name, job_announcement_id) => {
...
const jobAnnouncementApplier = (job_announcement_id) => {
  return `<h2>Your Applied Job Announcement Canceled By Us</h2>
    <p>Hello !\nThe Job Announcement with the code ${job_announcement_id} was closed by us. If something problem, contact us</p>`;
};

const jobApplicationApplier = (expertName, application_id) => {
...
const pendingWorkOwner = (clientName, pendingWorkID) => {
...
const pendingWorkRequester = (pendingWorkID) => {
  return `<h2>Your Requested Pending Work Canceled By Us</h2>
<p>Hello !\nThe Pending Work with the code ${pendingWorkID} was closed by us. If something problem, contact us</p>`;
};

const workOwner = (clientID, work_id) => {
...
const workExpert = (expertID, work_id) => {
...
const expertOffer = (expertName, offer_id) => {
